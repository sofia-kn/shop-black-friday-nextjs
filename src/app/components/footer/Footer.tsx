...
const Footer = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center border-t-[0.5px] text-center px-[4rem] py-[4rem] lg:px-[3rem] lg:py-[3rem] xl:px-[5rem] xl:py-8 border-gray-600 font-M">
