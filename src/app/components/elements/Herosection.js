...
function HeroSection() {
    return (<div className="flex h-auto w-full lg-max:w-[90%] 3xl-max:w-[75%] flex-col justify-start items-center  mt-[115px] md:mt-[157px] lg:mt-[175px] lg-max:mt-[212px] 3xl-max:mt-[215px]  px-2">
