...
function MainDescription(_a) {
    var mt = _a.mt, mTop = _a.mTop, pText = _a.pText;
    return (<div className={"m-8 mt-".concat(mTop, " lg:w-1/2 flex justify-between flex-col lg:mt-[").concat(mt, "] ")}>
