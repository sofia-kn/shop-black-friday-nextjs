...
var PaginationControls = function (_a) {
    ...
    var per_page = (_c = searchParams.get("per_page")) !== null && _c !== void 0 ? _c : "5";
    return (<div className="flex gap-2">
      <button className="borderRed px-[1.5rem] py-[0.5rem] text-white text-[1.5rem] bg-red-500">
        1
      </button>
      <button className="borderRed px-[1.5rem] py-[0.5rem] text-[#FF4955] text-[1.5rem] hover:bg-red-500 hover:text-white" onClick={function () {
