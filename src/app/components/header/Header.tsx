            ...
            <header className="w-full flex h-[80px] absolute top-0  flex-row justify-between font-kr text-2xl px-5 mr-2 md:px-7  lg-max:px-[74px] 2xl-max:px-[90px] items-center">
                ...
                <div className="w-[420px] flex justify-center items-center">
                    <nav className="w-full hidden justify-between  lg-max:flex  mr-[100px] lg-max:mr-[90px] lg-max:ml-[10px] 3xl-max:ml-[8px] ">
                        ...
                        <Link className=" font-medium tracking-tighter text-gray-300 text-[17px] hover:text-[#FF4955] hover:underline" href="/shop">
                            SHOP
                        </Link>
                        <Link className=" font-medium text-gray-300 tracking-tighter text-[17px] hover:text-[#FF4955] hover:underline" href="/about">
                            ABOUT
                         </Link>
                        <Link className=" font-medium text-gray-300 tracking-tighter text-[17px] hover:text-[#FF4955] hover:underline" href="/contact">
                            CONTACT
                        </Link>
