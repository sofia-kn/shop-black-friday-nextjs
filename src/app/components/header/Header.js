    ...
    return (<div className="body-bg-image w-full h-screen flex flex-row justify-center items-center text-center">
            <header className="w-full flex h-[80px] absolute top-0  flex-row justify-between font-kr text-2xl px-5 mr-2 md:px-7  lg-max:px-[74px] 2xl-max:px-[90px] items-center">
                ...
                <button className="flex justify-center items-center p-3 active:border-dotted active:border-2 active:border-[#fc3746] lg-max:hidden" onClick={openMenuHandler}>
                    ...
                    {!openMenu ? (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 20 20"><path fill="#FC3746" d="M0 3h20v2H0zm0 6h20v2H0zm0 6h20v2H0z"/></svg>) : (<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 22 22"><path fill="#FC3746" d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12z"/></svg>)}
                </button>
