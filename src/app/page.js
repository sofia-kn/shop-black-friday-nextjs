    ...
    <main className="flex flex-col items-center justify-between">
      ...
      <div className="container relative bgImg">
        <div className=" text-white flex flex-col lg:flex-row-reverse justify-evenly items-center">
          ...
          <MainDescription mtop={"8"} pText={"You can trust us to bring you the latest technology at unbeatable prices. Don’t miss this limited-time opportunity to upgrade your audio game. Grab your perfect pair now!"}/>
        </div>
      </div>
